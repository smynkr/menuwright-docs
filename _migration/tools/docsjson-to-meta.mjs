...
const PRODUCT_ROOT_META = {
  menuwright: { icon: 'utensils', description: 'AI menu engineering for independent restaurants — matrix analysis, dollar-impact recommendations, and POS or CSV ingestion.' },
};
