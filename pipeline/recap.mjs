 ...
 * of a single app repository (smynkr/MenuMakeover). Stripped-down sibling of axiom-docs'
 * weekly-recap.mjs: one repo, one changelog, zero LLM.
 *
 * Usage:
 *   node pipeline/recap.mjs --repo smynkr/MenuMakeover [--dry-run]
 *   node pipeline/recap.mjs --repo smynkr/MenuMakeover --since 2026-07-20 --until 2026-07-26
 *   node pipeline/recap.mjs --repo smynkr/MenuMakeover --force  # overlap/backfill
 *
...
const CHANGELOG_PATH = path.join(REPO_ROOT, "menuwright", "changelog.mdx");
