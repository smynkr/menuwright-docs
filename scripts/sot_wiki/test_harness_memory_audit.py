...
VALID_MANIFEST = {
    "schema_version": 1,
    "project_id": "menuwright-docs",
    "wiki_root": "docs/wiki",
    "agent_sot": "docs/AGENT_SOT.md",
    "graphiti_group_id": "menuwright-docs",
}
...
class HarnessMemoryAuditTests(unittest.TestCase):
    ...
    def test_valid_repository_passes(self) -> None:
        ...
        self.assertEqual("PASS harness-memory audit: menuwright-docs\n", result.stdout)
        self.assertEqual("", result.stderr)
        ...
        for field in ("project_id", "graphiti_group_id"):
            with self.subTest(field=field):
                self.assert_blocked(
                    ...
                    f"{field} must equal 'menuwright-docs'",
                )
    ...
    def test_checkclear_group_must_match_manifest_identity(self) -> None:
        ...
        self.assert_blocked(
            root,
            "checkclear graphiti group_id must equal 'menuwright-docs'",
        )
