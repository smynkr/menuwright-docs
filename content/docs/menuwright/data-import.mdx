...
description: Add menu items manually, upload food costs, estimate missing costs
  with AI, or explore with built-in sample data.
keywords:
  - data import
  - menu items
  - food cost
...
<Cards>
  <Card icon={<FileText />} title="CSV and Excel import" href="/menuwright/csv-import">
