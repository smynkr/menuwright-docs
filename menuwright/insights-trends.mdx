...
- **Trends** compares completed analyses over time so you can see whether the menu is moving in the right direction.
...
With one analysis, Trends shows that one analysis is complete and asks you to run a second analysis. It previews the two comparisons that become useful with more history:
